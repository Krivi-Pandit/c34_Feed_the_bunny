...
var noStar, oneStar, twoStar, scoreStar;
...
function setup() 
{
  ...
  scoreStar = createSprite(50,20,30,30);
  scoreStar.scale = 0.2;
  scoreStar.addAnimation('no_star',noStar);
  scoreStar.addAnimation('one_star',oneStar);
  scoreStar.addAnimation('two_star',twoStar);
  scoreStar.changeAnimation('no_star');
...
function draw() 
{
  ...
  if(collide(fruit,star,20)===true){
    star.visible = false;
    scoreStar.changeAnimation('one_star');
  ...
  if((collide(fruit,star2,40)===true)){
    //star.visible = false;
    star2.visible = false;
    scoreStar.changeAnimation('two_star');
    
  }

  /*if(((collide(fruit,star,20)===true)&&(collide(fruit,star2,40)===false))||((collide(fruit,star,20)===false)&&(collide(fruit,star2,40)===true))){
    scoreStar.changeAnimation('one_star');
    if(collide(fruit,star,20)===true){
      star.visible = false;
    }
